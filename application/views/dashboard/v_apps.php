							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="<?php echo base_url('dashboard/apps_act') ?>" method="post" enctype="multipart/form-data">											
								...
								foreach($apps as $p){ 									
									...
									<tr>
										...
										<td>
											...
											<a title="Akses Aplikasi" href="<?= base_url('dashboard/akses/'.$p->apps_id);?>" type="button" class="btn btn-warning btn-sm"><i class="fa fa-exclamation-triangle"></i></a>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="<?php echo base_url().'dashboard/apps_hapus/'.$p->apps_id; ?>" class="btn btn-primary">Hapus</a>
														</div>
													</div>
												</div>
											</div>
