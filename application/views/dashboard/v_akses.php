				...
				<div class="box box-primary">
					<div class="box-header">
						...
						<div class="pull-right">
                            ...
                            <button onclick="window.history.go(-1)" type="button" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"></i>  &nbsp Kembali</button>
						</div>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="<?php echo base_url('dashboard/akses_act') ?>" method="post" enctype="multipart/form-data">											
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="<?php echo base_url().'dashboard/akses_hapus?akses_id='.$p->akses_id.'&apps_id='.$p->apps_id; ?>" class="btn btn-primary">Hapus</a>
														</div>
													</div>
												</div>
											</div>
