							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="<?php echo base_url('status/status_pegawai_act') ?>" method="post" enctype="multipart/form-data">											
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<form action="<?php echo base_url('status/status_pegawai_update') ?>" method="post" enctype="multipart/form-data">
																<div class="form-group" style="width:100%">
																	<label style="width: 100%;"> Nama Status Kepegawaian</label>	
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="<?php echo base_url().'status/status_pegawai_hapus/'.$p->status_pegawai_id; ?>" class="btn btn-primary">Hapus</a>
														</div>
													</div>
												</div>
											</div>
