							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="<?php echo base_url('bagian/divisi_bagian_act') ?>" method="post" enctype="multipart/form-data">											

											<div class="form-group" style="width:100%">
												<label style="width: 100%;">Divisi</label>				
												<select class="form-control" name="divisi_id" id="pilihDivisi" required style="width: 100%;">
													<option value="">--Pilih Divisi--</option>
													<?php 
														$div = $this->db->query("select * from divisi order by divisi_nama")->result();
														foreach ($div as $d) {
													?>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<form action="<?php echo base_url('bagian/divisi_bagian_update') ?>" method="post" enctype="multipart/form-data">
																...
																<div class="form-group" style="width:100%">
																	...
																	<select class="form-control" name="divisi_id" required style="width: 100%;">
																		...
																		<?php 
																			...
																			foreach ($div as $d) {
																		?>
																			<option value="<?php echo $d->divisi_id ?>" <?php if($d->divisi_id == $p->divisi_id){echo "selected";} ?>><?php echo $d->divisi_nama ?></option>
																		<?php
																			}
																		?>													
																	</select>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<a href="<?php echo base_url().'bagian/divisi_bagian_hapus/'.$p->divisi_bagian_id; ?>" class="btn btn-primary">Hapus</a>
														</div>
													</div>
												</div>
											</div>
