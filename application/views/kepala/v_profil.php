				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<?php foreach($profil as $p){ ?>
							...
							<form method="post" enctype="multipart/form-data" action="<?php echo base_url('kepala/profil_update') ?>">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<input type="text" name="username" class="form-control" placeholder="Masukkan username .." value="<?php echo $p->user_username; ?>">
