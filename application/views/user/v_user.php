					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body" style="height: 420px; overflow-y: scroll;">
								...
								<form id="addAkun" action="<?php echo base_url('user/user_act') ?>" method="post" enctype="multipart/form-data">
									<div class="form-group" style="width:100%">
										<label style="width: 100%;"> Nama Pegawai</label>	
										<select class="form-control" onchange="changeEmail()" name="nama" required style="width: 100%;" id="namaPegawai">
											<option value="">--Pilih Pegawai--</option>
											<?php 
												$peg = $this->db->query("select * from pegawai where is_active = 1 order by pegawai_nama")->result();
												foreach ($peg as $pg) {
											?>
									...
									<div class="form-group" style="width:100%">
										...
										<input type="text" style="width:100%" name="username" id="emailPegawai" readonly required class="form-control">
									</div>
